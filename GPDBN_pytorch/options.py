...
def parse_args():
    ...
    parser.add_argument('--dataroot', default='/media/user/Disk 02/wangzhiqin/TensorMulti/GPDBN_pytorch/', help="datasets")
    parser.add_argument('--datatype', default='trimodal_data_slct32_5folds.pkl', help="datatype")
    parser.add_argument('--model_save', type=str, default='/media/user/Disk 02/wangzhiqin/TensorMulti/GPDBN_pytorch/model_save',help='models are saved here')
    parser.add_argument('--results', type=str, default='/media/user/Disk 02/wangzhiqin/TensorMulti/GPDBN_pytorch/results', help='results are saved here')
    parser.add_argument('--exp_name', type=str, default='GPDBN_results', help='name of the project. It decides where to store samples and models')
    parser.add_argument('--gpu_ids', type=str, default='1', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
    parser.add_argument('--model_name', type=str, default='test', help='mode')
    parser.add_argument('--input_size', type=int, default=32, help="input_size for feature vector")
    ...
    parser.add_argument('--lr', default=0.0002, type=float, help='5e-4 for Adam | 1e-3 for AdaBound') #0.00012
    parser.add_argument('--lambda_reg', type=float, default=0.0003)
